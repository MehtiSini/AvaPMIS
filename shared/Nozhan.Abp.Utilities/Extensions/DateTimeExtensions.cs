...
namespace System
{
    public static class DateTimeExtensions {
        ...
        {
            return CalculateAge(dateOfBirth, DateTime.Now);
        }
        ...
        public static DateTimeOffset ToDateTimeOffset(this DateTime localDateTime, TimeZoneInfo localTimeZone)
        {
            ...
            return TimeZoneInfo.ConvertTime(localDateTime, localTimeZone, TimeZoneInfo.Utc);
        }
        ...
        {
            return date.GetFirstDayOfWeek(CultureInfo.DefaultThreadCurrentUICulture);
        }
        ...
        {
            return date.GetLastDayOfWeek(CultureInfo.DefaultThreadCurrentUICulture);
        }
        ...
        {
            return date.GetWeeksWeekday(weekday, CultureInfo.DefaultThreadCurrentUICulture);
        }
        ...
        {
            return GetDays(year, CultureInfo.DefaultThreadCurrentUICulture);
        }
        ...
        {
            var first = culture.Calendar.ToDateTime(year, 1, 1, 0, 0, 0, 0);
            var last = culture.Calendar.ToDateTime(year + 1, 1, 1, 0, 0, 0, 0);
        ...
        {
            return GetDays(date.Year, CultureInfo.DefaultThreadCurrentUICulture);
        }
        ...
        {
            return GetWeekOfYear(dateTime, CultureInfo.DefaultThreadCurrentUICulture);
        }
        ...
        public static string ToFriendlyDateString(this DateTime date, CultureInfo culture)
        {
            ...
            else if (date.Date > DateTime.Today.AddDays(-6))
            {
                ...
                sbFormattedDate.Append(date.ToString("dddd",culture));
            }
            else
            {
                sbFormattedDate.Append(date.ToString("MMMM dd, yyyy",culture));
            }
        ...
        {
            return ToFriendlyDateString(date, CultureInfo.DefaultThreadCurrentUICulture);
        }
