...
{
    /// <summary>
    /// Validate persian shetab card format
    /// </summary>
    public class PersianShetabCardValidatorAttribute : System.ComponentModel.DataAnnotations.ValidationAttribute
    {
        public PersianShetabCardValidatorAttribute() : base()
        {
        }
        ...
        public override bool IsValid(object value)
        {
            ...
            {
                return val.IsValidIranShetabNumber();
            }
        }
        ...
        public void EnsureErrorMessageResource()
        {
            ...
            {
                ErrorMessageResourceName = "InvalidShetabCardError";
            }
        }
