            ...
            foreach (PropertyInfo targetProperty in targetProperties)
            {
                ...
                if (targetProperty.CanWrite)
                {
                    ...
                    else
                    {
                        ...
                        {
                            object objPropertyValue = sourceProperty.GetValue(objSource, null);
            ...
            foreach (PropertyInfo targetProperty in targetProperties)
            {
                ...
                if (targetProperty.CanWrite)
                {
                    ...
                    else
                    {
                        ...
                        {
                            object objPropertyValue = sourceProperty;
                            if (objPropertyValue == null)
                            {
                                targetProperty.SetValue(objTarget, null, null);
                            }
            ...
            object targetObj, PropertyInfo targetProperty, bool ignoreCase, params string[] excludedProperties)
        {
            ...
            if (targetProperty.CanWrite)
            {
                ...
                if (sourceProperty.PropertyType != targetProperty.PropertyType)
                {
                    ...
                    {
                        object objPropertyValue = sourceProperty.GetValue(sourceObj, null);
                        if (objPropertyValue == null)
                        {
