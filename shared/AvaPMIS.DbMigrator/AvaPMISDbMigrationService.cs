...
public class AvaPMISDbMigrationService : ITransientDependency
{
    private readonly ICurrentTenant _currentTenant;
    private readonly IDataSeeder _dataSeeder;
    private readonly ILogger<AvaPMISDbMigrationService> _logger;
    private readonly ITenantRepository _tenantRepository;
    private readonly IUnitOfWorkManager _unitOfWorkManager;

    public AvaPMISDbMigrationService(
        ILogger<AvaPMISDbMigrationService> logger,
        ...
        CancellationToken cancellationToken)
    {
        using (var uow = _unitOfWorkManager.Begin(true))
        {
            ...
            await MigrateDatabaseAsync<MainDbContext>(cancellationToken);
