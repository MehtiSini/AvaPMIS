...
namespace AvaPMIS.IdentityService.OpenIddict
{
    public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
    {
        ...
        {
            var clients = _configuration.GetSection("OpenIddict").GetSection("Clients").Get<List<ServiceClient>>();
        ...
        {
            var apiResources = _configuration.GetSection("OpenIddict").GetSection("ApiResource").Get<string[]>();
